...
func (h Handler) CreateTransaction(c *gin.Context) {
	...
	createdTrans, err := h.storage.Transaction().GetById(context.Background(), models.PrimaryKey{ID: id})
	if err != nil {
...
func (h Handler) GetTransaction(c *gin.Context) {
	...
	trans, err := h.storage.Transaction().GetById(context.Background(), models.PrimaryKey{ID: uid})
	if err != nil {
		handleResponse(c, "error is while getting by id", http.StatusInternalServerError, err.Error())
		return
	}
...
func (h Handler) UpdateTransaction(c *gin.Context) {
	...
	updatedTrans, err := h.storage.Transaction().GetById(context.Background(), models.PrimaryKey{ID: id})
	if err != nil {
		handleResponse(c, "error is while getting by id", http.StatusInternalServerError, err.Error())
		return
	}
